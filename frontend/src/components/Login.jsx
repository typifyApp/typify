...
Login.propTypes = {
  ...
  loginPageErrorText: PropTypes.string.isRequired,
  setLoginPageErrorText: PropTypes.func.isRequired,
  userData: PropTypes.shape({ username: PropTypes.string.isRequired }).isRequired,
